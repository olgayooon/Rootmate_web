...
export const PLANTS: PlantData[] = [
  {
    ...
    cardIntro: '열대 아시아가 원산지인 향긋한 허브예요. 민트 향과 은은한 정향 향이 어우러져 다양한 요리에 활용할 수 있어요. 발아가 쉬워 처음 식물을 키우는 분도 부담 없이 시작할 수 있어요.',
...

  {
    ...
    cardIntro: '빨갛게 익기까지는 시간이 걸리지만, 기다린 만큼 달콤한 열매를 선물해 주는 식물이에요. 수확량이 많아 키우는 재미와 성취감을 함께 느낄 수 있어요.',
    ...
    suitability: {
      home: {
        score: 4,
        description: '햇빛이 충분한 창가나 베란다에서 잘 자라요. 공간이 어느 정도 필요해요.',
      },
      office: {
        score: 2,
        description: '하루 8시간 직사광선이 필요해 일반 사무실 환경은 어려울 수 있어요.',
      },
      difficulty: 'medium',
...

  {
    ...
    cardIntro: '추운 겨울을 견디고 봄이 되면 꽃을 피우는 식물이에요. 보이지 않는 시간에도 묵묵히 준비하며, 기다림 끝에 아름다운 꽃을 선물해요.',

    selfIntro: '안녕하세요. 저는 튤립이에요. 🌷\n\n제가 꽃을 피우기까지는 조금 시간이 걸려요. 추운 시간을 견뎌야 봄에 꽃을 피울 수 있거든요.\n\n지금 당장 눈에 보이지 않아도, 저는 계속 준비하고 있답니다.\n\n물은 흙이 마를 때만 주세요. 과습하면 구근이 썩을 수 있어요. 하루 6시간 정도 햇빛을 받으면 충분해요.\n\n꽃이 지고 나서도 잎이 완전히 마를 때까지 기다려 주세요. 구근에 영양이 저장되는 중이거든요.\n\n그래야 다음 해에도 다시 꽃을 피울 수 있어요.\n\n기다려 주셔서 감사해요. 당신의 하루도 꽃처럼 피어나길 바라요. 🌷',
    ...
    suitability: {
      ...
      difficulty: 'medium',
      difficultyLabel: '보통 — 냉장 처리가 핵심이에요',
      period: '이듬해 3~4월 개화',
    },
    ...
    care: {
      ...
      temperature: '냉장 처리 필수 (4~5°C, 8~10주). 이후 서늘한 실온',
      pot: '깊은 화분 필요. 최소 깊이 20cm 이상',
    },

    growthSteps: [
      { step: 1, title: '구근 준비', description: '심기 전 하루 정도 서늘한 곳에 두어 환경에 적응시켜요. 시기는 10~11월이 좋아요.' },
      { step: 2, title: '심기', description: '뾰족한 부분이 위를 향하도록 10~15cm 깊이로 심어요.' },
      { step: 3, title: '냉장 처리', description: '냉장고(4~5°C)에 8~10주 보관해요. 이 과정이 없으면 꽃이 피지 않아요.' },
      { step: 4, title: '발아 후 관리', description: '냉장 처리 후 햇빛 있는 곳으로 옮기면 싹이 올라와요. 물은 흙이 마를 때만요.' },
      { step: 5, title: '개화', description: '충분히 자라면 3~4월에 꽃을 피워요. 기다림의 보상이에요.' },
